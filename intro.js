...
#minhaMarvelIntro .progress{position:absolute;left:0;right:0;bottom:0;height:3px;z-index:12;background:rgba(255,255,255,.08)}#minhaMarvelIntro .progress i{display:block;height:100%;width:0;background:linear-gradient(90deg,#9e001d,#ff294e,#fff);animation:mmProgress 6.8s linear both}
...
playSound();
timer=setTimeout(close,Math.max(5000,Number(prefs.duration)||6800));
