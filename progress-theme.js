...
(()=>{const brand=document.querySelector('.brand span');if(brand)brand.textContent='SMART CALENDAR EDITION 7.2.1';document.title='Minha Marvel 7.2.1';const s=document.createElement('script');s.src='smart-calendar.js?v=7.2.1';document.body.appendChild(s)})();